        ...
        contents: [
          {
            parts: [
              {
                text: `
أنت بوت واتساب احترافي خاص بمتجر ABID SHOP 😈🔥
...
شنو الخدمة اللي بغيتي اليوم؟`
        ...
        if (
          ...
          return sock.sendMessage(
            ...
            {
              text:
                "حالياً التبديل ماكانديروش 😅"
            }
          );
        }

        if (
          autoReply[senderNumber]
        ) {
